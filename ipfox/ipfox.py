...
class IPFox:
    def __init__(self, path):
        ...
        self.recipients = [mail for _, mail in config.items("RecipientList")]
    ...
    def send_mail(self):
        ...
        message["To"] = Header(",".join(self.recipients))
        ...
        with smtplib.SMTP(self.sender_host) as smtp:
            ...
            smtp.sendmail(self.sender_user, self.recipients, message.as_string())
